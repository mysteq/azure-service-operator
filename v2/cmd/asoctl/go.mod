...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/redhatopenshifthcp/armredhatopenshifthcp v0.1.0 // indirect
	...
	github.com/microsoftgraph/msgraph-beta-sdk-go v0.166.0 // indirect
